...
import { updateModule } from '@/app/(dashboard)/educator/actions'
import { YouTubePreviewInput } from '@/components/YouTubePreviewInput'

export const metadata = { title: 'Edit Module — Alya' }
...
export default async function EditModulePage({ params }: { params: Promise<{ moduleId: string }> }) {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-8">
        <Link href={`/educator/modules/${mod.id}`} className="text-sm font-medium text-[var(--alya-purple)] hover:underline mb-2 inline-block">
        ...
        <p className="mt-1 text-sm text-gray-500">
          Update the settings and details for this module.
        </p>
      </div>

      <div className="rounded-2xl border border-[var(--alya-purple-light)] bg-white p-6 shadow-sm">
        <form action={updateModuleWithId} className="space-y-6">
          ...
          <div className="space-y-1.5">
            ...
            <YouTubePreviewInput
              ...
              defaultValue={mod.previewVideoUrl || ''}
